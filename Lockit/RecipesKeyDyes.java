...
public class RecipesKeyDyes implements IRecipe
{
    /**
    ...
    public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        for (int var5 = 0; var5 < par1InventoryCrafting.getSizeInventory(); ++var5)
        {
            ...
            if (var6 != null)
            {
                if (var6.getItem() instanceof ItemKey)
                {
                    ItemKey var7 = (ItemKey)var6.getItem();
                    var3 = var6;
                }
                else
                {
        ...
        boolean result = var3 != null && !var4.isEmpty();
        return result;
    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
    {
        ...
        for (var7 = 0; var7 < par1InventoryCrafting.getSizeInventory(); ++var7)
        {
            ...
            if (var8 != null)
            {
                if (var8.getItem() instanceof ItemKey)
                {
                    var6 = (ItemKey)var8.getItem();
                    var2 = var8.copy();

                    if (var6.getColor(var8) != 10511680)
                    {
