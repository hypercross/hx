...
public class BlockLift extends Block{
	...
	private Object reflectCall(Object thing, String name, Object... params)
	{
		try
		{
	...
	private boolean canExtend(World par1World, int x,int y,int z, int dir)
	{
		return (Boolean) reflectCall(Block.pistonBase, "canExtend", par1World, x,y,z,dir);
	}
	...
	public void onBlockEventReceived(World par1World, int par2, int par3, int par4, int par5, int par6)
	{
		...
		if(par5 == 0 && canExtend(par1World,x,y,z, 1))
		{
			if (tryExtend(par1World, x,y,z, 1))
			{
